...
public class Game {
  ...
  final String helpmsg = "Push button when light turns on";
  final String startmsg = "Touch START on screen to start";
  ...
  private void showStartScreen() {
     ...
     textSize(48);
     fill(255);
     tw = textWidth(startmsg)/2;
     text(startmsg, width/2-tw, height/2-200);
     tw = textWidth(helpmsg)/2;
     text(helpmsg, width/2-tw, height/2-300);
  }
